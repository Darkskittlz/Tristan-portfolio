        ...
        <Container maxW='2x1'>
          <GridContainer>
            ...
            >
              <TitleContainer>
                <ImageContainer>
                  <img src="https://github.com/Darkskittlz/Tristan-portfolio/blob/master/src/assets/images/ThreeJS/scrollAnimation.png?raw=true" />
                </ImageContainer>
                <h1><Badge colorScheme="blue"></Badge></h1>
              </TitleContainer>
              <BodyContainer>
                <h1>
                ...
                <List ml={4} my={4} style={{ display: "flex", flexDirection: "column" }}>
                  <ListItem>
                    ...
                    <span>ThreeJS, Vite, GSAP, lil-gui </span>
                  </ListItem>
                  <ListItem>
                    <Badge2>Website</Badge2>
                    <Link
                      href="https://darkskittlz-scroll-animation.netlify.app/"
                      target="_blank"
                      style={{
                        color: "#b900ff"
                      }}
                    >
                      https://darkskittlz-scroll-animation.netlify.app/
                  ...
                  <ListItem>
                    ...
                    <Link
                      href="https://github.com/Darkskittlz/19-Scroll-Based-Animation"
                      target="_blank"
                      style={{
                        color: "#b900ff"
                      }}
                    >
                      https://github.com/Darkskittlz/19-Scroll-Based-Animation
                      <ExternalLinkIcon mx="2px" />
                    </Link>
                  </ListItem>
                </List>
